...
:::: {.columns}
::: {.column width="50%"}
### EVM enables countries to strengthen the iSC

When all links in the supply chain are effectively monitored, assessed and continually
improved, the health and wellbeing of people improves.
:::

::: {.column width="50%"}
![](img_who/isc.jpg){width="100%" fig-align="center"}
:::
::::
...
- Explain performance and coverage using causal machine learning.
...
::: fragment
### Expected Impact
The output of this project will support policymakers in allocating resources more effectively, selecting high-impact interventions, and improving the efficiency, resilience, and equity of vaccine delivery systems.
:::
