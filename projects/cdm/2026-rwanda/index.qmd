...
```{=html}
<a href="2026-1-phdfoundation.pdf" download class="btn btn-primary btn-sm">
  <i class="bi bi-file-earmark-pdf"></i> Download PDF
</a>

<iframe src="2026-1-phdfoundation.html" width="100%" height="550px" style="border:none; margin-top: 10px;"></iframe>
```
